...
SSIM_List_LSB_pair_new = zeros(imageNum, 1);
...
for i = 1: 10
    ...
    [hieght, width] = LSB_pair_1(hostImage, 'watermark.txt', strcat('LSB-pair photo\', strcat(imageName, '.png')));
    ...
    [hieght, width] = LSB_pair_dual(hostImage, 'watermark.txt', strcat('LSB_pair_ultra photo\', strcat(imageName, '.png')));
    ...
    %     SSIM_List_LSB_pair_new(i) = SSIM_pair_new;
...
PSNR_header = {'Image Name', 'LSB', 'LSB-pair' 'LSB-pair-ultar'};
